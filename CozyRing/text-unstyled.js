...
// Modified by Gray (GraysTea.neocities.org) Jan. 31, 2022. Refactored variables and widget files. Replaced tables with a more flexible setup. Got rid of external CSS files.  All credit goes to the original OnionRing Creators.
...
if (thisIndex == null) {
  ...
  tag.insertAdjacentHTML('afterbegin', `
      ...
      ${indexText}
      <a id="CozyRingHome" href="https://graystea.neocities.org/content/grays-tea/join-cozy-ring.html">${ringName}</a>
      ${randomText}
