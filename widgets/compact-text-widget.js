...
#CozyRing table tr td {
 
}

#CozyRing table tr td a {
 padding: 0rem 0.05rem;
}

#CozyRing .webring-prev {
  text-align:right;
}
...
#CozyRing .webring-next {
  text-align:left;
}

#CozyRing .webring-links {
  font-size:small;
}
...
if (thisIndex == null) {
  ...
  <table>
  <tr>
    <td>Not yet a member of ${ringName}. Contact <a href="https://discord.com/invite/JM34yvMaFP">Gray [https://tinyurl.com/CozyRing]</a></td>
  </tr>
</table>
  `);
}
  ...
  <table>
    <tr>
      ...
      <td> ${indexText} </td>
      <td class='webring-info'><a href="https://graystea.neocities.org/CozyRing/CozyRing.html">${ringName}</a></br></td>
      <td> ${randomText} </td>
